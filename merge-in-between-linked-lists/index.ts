...
export default function mergeInBetween(
    ...
    // const start_of_third = get_deep_next_of_list(list1, b + 1)
    end_of_first.next = list2;
    end_of_list2.next = start_of_third;
    return start_of_first;
}

// function get_deep_next_of_list(list1: ListNode, a: number): ListNode {

//     for (let i = 0; i < a; i++) {

//         if (list1.next) { list1 = list1.next } else { throw Error('out of bounds'+a) }
//     }
//     return list1
// }
