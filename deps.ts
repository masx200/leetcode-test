...
import { BinaryHeap } from "https://deno.land/std@0.179.0/collections/binary_heap.ts";
import { Deque } from "https://esm.sh/@datastructures-js/deque@1.0.4/";
import { RedBlackNode } from "https://deno.land/std@0.179.0/collections/red_black_node.ts";
...
export { BinaryHeap };
export { walk } from "https://deno.land/std@0.179.0/fs/mod.ts";
...
export type { WalkEntry } from "https://deno.land/std@0.179.0/fs/_util.ts";
