...
import { BinaryHeap } from "https://deno.land/std@0.175.0/collections/binary_heap.ts";
import { RedBlackNode } from "https://deno.land/std@0.175.0/collections/red_black_node.ts";
...
export { isIP } from "https://deno.land/std@0.175.0/node/internal/net.ts";
...
export type { WalkEntry } from "https://deno.land/std@0.175.0/fs/_util.ts";
