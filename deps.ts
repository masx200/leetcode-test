...
import { BinaryHeap } from "https://deno.land/std@0.184.0/collections/binary_heap.ts";
...
export { BinaryHeap };
export { walk } from "https://deno.land/std@0.184.0/fs/mod.ts";
...
export type { WalkEntry } from "https://deno.land/std@0.184.0/fs/_util.ts";
