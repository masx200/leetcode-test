...
export { walk } from "https://deno.land/std@0.152.0/fs/mod.ts";
...
export { isIP } from "https://deno.land/std@0.152.0/node/internal/net.ts";
export { Heap } from "https://cdn.skypack.dev/@datastructures-js/heap@4.1.1/?dts";
export {
    BinarySearchTree,
    BinarySearchTreeNode,
} from "https://cdn.skypack.dev/@datastructures-js/binary-search-tree@5.0.2/?dts";
